...
TITHI_RULES = [
    ...
    # ── MONTHLY VRATAS (Ekadashi, Pradosha, Sankashti) ─────────────────────
    # Ekadashi (11) — named Vaishnava list; observed statewide (common)
    ("Chaitra",    "shukla", 11,  "common", "Kamada Ekadashi",            "କାମଦା ଏକାଦଶୀ",            "Vishnu fasting day of Chaitra bright fortnight; prayer for fulfilment of righteous wishes"),
    ("Chaitra",    "krishna", 11, "common", "Papamochani Ekadashi",       "ପାପମୋଚନୀ ଏକାଦଶୀ",       "Dark-fortnight Ekadashi of Chaitra; traditionally for release from sins"),
    ("Vaishakha",  "shukla", 11,  "common", "Mohini Ekadashi",            "ମୋହିନୀ ଏକାଦଶୀ",           "Bright-fortnight Ekadashi of Vaishakha"),
    ("Vaishakha",  "krishna", 11, "common", "Varuthini Ekadashi",         "ବରୂଥିନୀ ଏକାଦଶୀ",          "Dark-fortnight Ekadashi of Vaishakha"),
    ("Jyeshtha",   "shukla", 11,  "common", "Nirjala Ekadashi",           "ନିର୍ଜଳା ଏକାଦଶୀ",          "Waterless Vishnu fast of Jyeshtha bright fortnight — among the strictest Ekadashis"),
    ("Jyeshtha",   "krishna", 11, "common", "Apara Ekadashi",             "ଅପରା ଏକାଦଶୀ",              "Dark-fortnight Ekadashi of Jyeshtha"),
    ("Ashadha",    "shukla", 11,  "common", "Devshayani / Padma Ekadashi","ଦେବଶୟନୀ / ପଦ୍ମା ଏକାଦଶୀ", "Start of Chaturmasya; Vishnu enters yogic rest in tradition"),
    ...
    ("Chaitra",    "krishna", 13, "common", "Pradosha Vrat",              "ପ୍ରଦୋଷ ବ୍ରତ",              "Krishna Trayodashi evening vrat for Lord Shiva"),
    ("Vaishakha",  "shukla", 13,  "common", "Pradosha Vrat",              "ପ୍ରଦୋଷ ବ୍ରତ",              "Shukla Trayodashi evening vrat for Lord Shiva"),
    ("Vaishakha",  "krishna", 13, "common", "Pradosha Vrat",              "ପ୍ରଦୋଷ ବ୍ରତ",              "Krishna Trayodashi evening vrat for Lord Shiva"),
    ("Jyeshtha",   "shukla", 13,  "common", "Pradosha Vrat",              "ପ୍ରଦୋଷ ବ୍ରତ",              "Shukla Trayodashi evening vrat for Lord Shiva"),
    ("Jyeshtha",   "krishna", 13, "common", "Pradosha Vrat",              "ପ୍ରଦୋଷ ବ୍ରତ",              "Krishna Trayodashi evening vrat for Lord Shiva"),
    ("Ashadha",    "shukla", 13,  "common", "Pradosha Vrat",              "ପ୍ରଦୋଷ ବ୍ରତ",              "Shukla Trayodashi evening vrat for Lord Shiva"),
    ("Ashadha",    "krishna", 13, "common", "Pradosha Vrat",              "ପ୍ରଦୋଷ ବ୍ରତ",              "Krishna Trayodashi evening vrat for Lord Shiva"),
    ("Shravana",   "shukla", 13,  "common", "Pradosha Vrat",              "ପ୍ରଦୋଷ ବ୍ରତ",              "Shukla Trayodashi evening vrat for Lord Shiva"),
    ("Shravana",   "krishna", 13, "common", "Pradosha Vrat",              "ପ୍ରଦୋଷ ବ୍ରତ",              "Krishna Trayodashi evening vrat for Lord Shiva"),
    ("Bhadrapada", "shukla", 13,  "common", "Pradosha Vrat",              "ପ୍ରଦୋଷ ବ୍ରତ",              "Shukla Trayodashi evening vrat for Lord Shiva"),
    ("Bhadrapada", "krishna", 13, "common", "Pradosha Vrat",              "ପ୍ରଦୋଷ ବ୍ରତ",              "Krishna Trayodashi evening vrat for Lord Shiva"),
    ("Ashwina",    "shukla", 13,  "common", "Pradosha Vrat",              "ପ୍ରଦୋଷ ବ୍ରତ",              "Shukla Trayodashi evening vrat for Lord Shiva"),
    ("Ashwina",    "krishna", 13, "common", "Pradosha Vrat",              "ପ୍ରଦୋଷ ବ୍ରତ",              "Krishna Trayodashi evening vrat for Lord Shiva"),
    ("Kartika",    "shukla", 13,  "common", "Pradosha Vrat",              "ପ୍ରଦୋଷ ବ୍ରତ",              "Shukla Trayodashi evening vrat for Lord Shiva"),
    ("Kartika",    "krishna", 13, "common", "Pradosha Vrat",              "ପ୍ରଦୋଷ ବ୍ରତ",              "Krishna Trayodashi evening vrat for Lord Shiva"),
    ("Margashira", "shukla", 13,  "common", "Pradosha Vrat",              "ପ୍ରଦୋଷ ବ୍ରତ",              "Shukla Trayodashi evening vrat for Lord Shiva"),
    ("Margashira", "krishna", 13, "common", "Pradosha Vrat",              "ପ୍ରଦୋଷ ବ୍ରତ",              "Krishna Trayodashi evening vrat for Lord Shiva"),
    ("Pausha",     "shukla", 13,  "common", "Pradosha Vrat",              "ପ୍ରଦୋଷ ବ୍ରତ",              "Shukla Trayodashi evening vrat for Lord Shiva"),
    ("Pausha",     "krishna", 13, "common", "Pradosha Vrat",              "ପ୍ରଦୋଷ ବ୍ରତ",              "Krishna Trayodashi evening vrat for Lord Shiva"),
    ("Magha",      "shukla", 13,  "common", "Pradosha Vrat",              "ପ୍ରଦୋଷ ବ୍ରତ",              "Shukla Trayodashi evening vrat for Lord Shiva"),
    ("Magha",      "krishna", 13, "common", "Pradosha Vrat",              "ପ୍ରଦୋଷ ବ୍ରତ",              "Krishna Trayodashi evening vrat for Lord Shiva"),
    ("Phalguna",   "shukla", 13,  "common", "Pradosha Vrat",              "ପ୍ରଦୋଷ ବ୍ରତ",              "Shukla Trayodashi evening vrat for Lord Shiva"),
    # Phalguna Krishna 14 is Maha Shivaratri — still also Trayodashi cycle nearby; Krishna 13 Pradosha:
    ("Phalguna",   "krishna", 13, "common", "Pradosha Vrat",              "ପ୍ରଦୋଷ ବ୍ରତ",              "Krishna Trayodashi evening vrat for Lord Shiva"),

    # Sankashti / Sankatahara Chaturthi — monthly Krishna Chaturthi Ganesha vrat
    ("Chaitra",    "krishna",  4, "common", "Sankashti Chaturthi",        "ସଙ୍କଷ୍ଟି ଚତୁର୍ଥୀ",         "Monthly Ganesha vrat on Krishna Chaturthi — relief from obstacles"),
    ("Vaishakha",  "krishna",  4, "common", "Sankashti Chaturthi",        "ସଙ୍କଷ୍ଟି ଚତୁର୍ଥୀ",         "Monthly Ganesha vrat on Krishna Chaturthi"),
    ("Jyeshtha",   "krishna",  4, "common", "Sankashti Chaturthi",        "ସଙ୍କଷ୍ଟି ଚତୁର୍ଥୀ",         "Monthly Ganesha vrat on Krishna Chaturthi"),
    ("Ashadha",    "krishna",  4, "common", "Sankashti Chaturthi",        "ସଙ୍କଷ୍ଟି ଚତୁର୍ଥୀ",         "Monthly Ganesha vrat on Krishna Chaturthi"),
    ("Shravana",   "krishna",  4, "common", "Sankashti Chaturthi",        "ସଙ୍କଷ୍ଟି ଚତୁର୍ଥୀ",         "Monthly Ganesha vrat on Krishna Chaturthi"),
    ("Bhadrapada", "krishna",  4, "common", "Sankashti Chaturthi",        "ସଙ୍କଷ୍ଟି ଚତୁର୍ଥୀ",         "Monthly Ganesha vrat on Krishna Chaturthi"),
    ("Ashwina",    "krishna",  4, "common", "Sankashti Chaturthi",        "ସଙ୍କଷ୍ଟି ଚତୁର୍ଥୀ",         "Monthly Ganesha vrat on Krishna Chaturthi"),
    ("Kartika",    "krishna",  4, "common", "Sankashti Chaturthi",        "ସଙ୍କଷ୍ଟି ଚତୁର୍ଥୀ",         "Monthly Ganesha vrat on Krishna Chaturthi"),
    ("Margashira", "krishna",  4, "common", "Sankashti Chaturthi",        "ସଙ୍କଷ୍ଟି ଚତୁର୍ଥୀ",         "Monthly Ganesha vrat on Krishna Chaturthi"),
    ("Pausha",     "krishna",  4, "common", "Sankashti Chaturthi",        "ସଙ୍କଷ୍ଟି ଚତୁର୍ଥୀ",         "Monthly Ganesha vrat on Krishna Chaturthi"),
    ("Magha",      "krishna",  4, "common", "Sankashti Chaturthi",        "ସଙ୍କଷ୍ଟି ଚତୁର୍ଥୀ",         "Monthly Ganesha vrat on Krishna Chaturthi"),
    ("Phalguna",   "krishna",  4, "common", "Sankashti Chaturthi",        "ସଙ୍କଷ୍ଟି ଚତୁର୍ଥୀ",         "Monthly Ganesha vrat on Krishna Chaturthi"),
